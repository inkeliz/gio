...
func (f *Functions) ClearColor(red, green, blue, alpha float32) {
	r, g, b, a := float64(red), float64(green), float64(blue), float64(alpha) // Float32 doesn't work
	f.Ctx.Call(_glClearColor, uintptr(unsafe.Pointer(&r)), uintptr(unsafe.Pointer(&g)), uintptr(unsafe.Pointer(&b)), uintptr(unsafe.Pointer(&a)))
}
func (f *Functions) ClearDepthf(d float32) {
	dd := float64(d) // Float32 doesn't work
	f.Ctx.Call(_glClearDepth, uintptr(unsafe.Pointer(&dd)))
}
...
func (f *Functions) GetError() Enum {
	...
	return Enum(f.Ctx.Call(_glGetError).Int())
}
...
func (f *Functions) Uniform1f(dst Uniform, v0 float32) {
	vv0 := float64(v0) // Float32 doesn't work
	f.Ctx.Call(_glUniform1f, uintptr(unsafe.Pointer(&dst)), uintptr(unsafe.Pointer(&vv0)))
}
...
func (f *Functions) Uniform3f(dst Uniform, v0, v1, v2 float32) {
	vv0, vv1, vv2 := float64(v0), float64(v1), float64(v2) // Float32 doesn't work
	f.Ctx.Call(_glUniform3f, uintptr(unsafe.Pointer(&dst)), uintptr(unsafe.Pointer(&vv0)), uintptr(unsafe.Pointer(&vv1)), uintptr(unsafe.Pointer(&vv2)))
}
func (f *Functions) Uniform4f(dst Uniform, v0, v1, v2, v3 float32) {
	vv0, vv1, vv2, vv3 := float64(v0), float64(v1), float64(v2), float64(v3) // Float32 doesn't work
	f.Ctx.Call(_glUniform4f, uintptr(unsafe.Pointer(&dst)), uintptr(unsafe.Pointer(&vv0)), uintptr(unsafe.Pointer(&vv1)), uintptr(unsafe.Pointer(&vv2)), uintptr(unsafe.Pointer(&vv3)))
}
