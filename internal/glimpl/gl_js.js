(() => {
    ...
    const TypeFloat64 = 4 | 0x10
    const TypeBoolean = 5 | 0x10
    const TypeString = 6 | 0x10
    const TypeSlice = 7 | 0x30
    const TypeSlice32 = 8 | 0x30
    const TypeValue = 9 | 0x40
    const TypeMethod = 10 | 0x40
    ...
    let types = {
        ...
        [TypeInt64]: {
            ...
            Decoder: function (addr) {
                return go.mem.getUint32(addr + 8, true); //+ (go.mem.getUint32(addr + 12, true) * 4294967296); Performance (:
            },
        },
        [TypeFloat64]: {
            Size: 8,
