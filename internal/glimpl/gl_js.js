(() => {
    ...
    const gioSetIntOrBoolean = (addr, v) => {
        ...
        gioSetInt64Value(addr, v);
    }

    Object.assign(go.importObject.go, {
        // initGL(ctx Context) (uint64, uint64)
        "gioui.org/internal/glimpl.initGL": (sp) => {
            ...
            gioSetInt64Value(sp + OffsetJSValue, ref - 1);
            gioSetInt64Value(sp + OffsetJSValue + OffsetInt64, error);
        },
        ...
        "gioui.org/internal/glimpl.getRenderbufferParameteri": (sp) => {
            ...
            sp = (go._inst.exports.getsp() >>> 0) + OffsetContextIndex;
            gioSetIntOrBoolean(sp + (OffsetInt64 * 2), result);
        },
        ...
        "gioui.org/internal/glimpl.getFramebufferAttachmentParameteri": (sp) => {
            ...
            sp = (go._inst.exports.getsp() >>> 0) + OffsetContextIndex;
            gioSetIntOrBoolean(sp + (OffsetInt64 * 3), result);
        },
        ...
        "gioui.org/internal/glimpl.getInteger": (sp) => {
            ...
            sp = (go._inst.exports.getsp() >>> 0) + OffsetContextIndex;
            gioSetIntOrBoolean(sp + OffsetInt64, result);
        },
        ...
        "gioui.org/internal/glimpl.getProgrami": (sp) => {
            ...
            sp = (go._inst.exports.getsp() >>> 0) + OffsetContextIndex;
            gioSetIntOrBoolean(sp + OffsetJSValue + OffsetInt64, result);
        },
        ...
        "gioui.org/internal/glimpl.getUniformBlockIndex": (sp) => {
            ...
            sp = (go._inst.exports.getsp() >>> 0) + OffsetContextIndex;
            gioSetIntOrBoolean(sp + OffsetJSValue + OffsetString, result);
        },
