...
func (f *Functions) BlendFuncSeparate(srcRGB, dstRGB, srcA, dstA Enum) {
	f.Ctx.Call(_glBlendFunc, uintptr(unsafe.Pointer(&srcRGB)), uintptr(unsafe.Pointer(&dstRGB)), uintptr(unsafe.Pointer(&srcA)), uintptr(unsafe.Pointer(&dstA)))
}

func (f *Functions) BufferData(target Enum, size int, usage Enum, data []byte) {
	if data == nil {
		f.Ctx.Call(_glBufferDataSize, uintptr(unsafe.Pointer(&target)), uintptr(unsafe.Pointer(&size)), uintptr(unsafe.Pointer(&usage)))
	} else {
		if len(data) != size {
			panic("size mismatch")
		}
		f.Ctx.Call(_glBufferData, uintptr(unsafe.Pointer(&target)), uintptr(unsafe.Pointer(&data)), uintptr(unsafe.Pointer(&usage)))
	}
}
func (f *Functions) BufferSubData(target Enum, offset int, src []byte) {
	f.Ctx.Call(_glBufferSubData, uintptr(unsafe.Pointer(&target)), uintptr(unsafe.Pointer(&offset)), uintptr(unsafe.Pointer(&src)))
}
...
func (f *Functions) CopyTexSubImage2D(target Enum, level, xoffset, yoffset, x, y, width, height int) {
	f.Ctx.Call(_glCopyTexSubImage2D, uintptr(unsafe.Pointer(&target)), uintptr(unsafe.Pointer(&level)), uintptr(unsafe.Pointer(&xoffset)), uintptr(unsafe.Pointer(&yoffset)), uintptr(unsafe.Pointer(&x)), uintptr(unsafe.Pointer(&y)), uintptr(unsafe.Pointer(&width)), uintptr(unsafe.Pointer(&height)))
}
...
func (f *Functions) GetBindingi(pname Enum, idx int) Object {
	obj := f.Ctx.Call(_glGetIndexedParameter, uintptr(unsafe.Pointer(&pname)), uintptr(unsafe.Pointer(&idx)))
	if obj.ref == 0 {
		return Object{}
	}
	return Object(obj)
...
func (f *Functions) GetFloat(pname Enum) float32 {
	return float32(f.Ctx.Call(_glGetParameteri, uintptr(unsafe.Pointer(&pname))).Int())
}

var _glGetParameterValue = newProc(_glTypeValue, "getParameter", _glTypeInt64)
var _glJoin = newProc(_glTypeString, "join", _glTypeString)

func (f *Functions) GetInteger4(pname Enum) [4]int {
	arr := f.Ctx.Call(_glGetParameterValue, uintptr(unsafe.Pointer(&pname)))
	divider := "|"
	var res [4]int
	for i, s := range strings.Split(arr.Call(_glJoin, uintptr(unsafe.Pointer(&divider))).String(), divider) {
...
func (f *Functions) GetVertexAttrib(index int, pname Enum) int {
	return f.Ctx.Call(_glGetVertexAttrib, uintptr(unsafe.Pointer(&index)), uintptr(unsafe.Pointer(&pname))).Int()
}
func (f *Functions) GetVertexAttribBinding(index int, pname Enum) Object {
	obj := f.Ctx.Call(_glGetVertexAttrib, uintptr(unsafe.Pointer(&index)), uintptr(unsafe.Pointer(&pname)))
	if obj.ref == 0 {
		return Object{}
	}
	return Object(obj)
...
var _glGetVertexAttribOffset = newProc(_glTypeInt64, "getVertexAttribOffset", _glTypeInt64, _glTypeInt64)

func (f *Functions) GetVertexAttribPointer(index int, pname Enum) uintptr {
	return uintptr(f.Ctx.Call(_glGetVertexAttribOffset, uintptr(unsafe.Pointer(&index)), uintptr(unsafe.Pointer(&pname))).Int())
}
...
func (f *Functions) IsEnabled(cap Enum) bool {
	return f.Ctx.Call(_glIsEnabled, uintptr(unsafe.Pointer(&cap))).ref != 0
}
...
func (f *Functions) TexImage2D(target Enum, level int, internalFormat Enum, width, height int, format, ty Enum) {
	f.Ctx.Call(_glTexImage2D, uintptr(unsafe.Pointer(&target)), uintptr(unsafe.Pointer(&level)), uintptr(unsafe.Pointer(&internalFormat)), uintptr(unsafe.Pointer(&width)), uintptr(unsafe.Pointer(&height)), uintptr(unsafe.Pointer(&_zero)), uintptr(unsafe.Pointer(&format)), uintptr(unsafe.Pointer(&ty)), 0)
}

var _glTexStorage2D = newProc(_glTypeNull, "texStorage2D", _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64)

func (f *Functions) TexStorage2D(target Enum, levels int, internalFormat Enum, width, height int) {
	f.Ctx.Call(_glTexStorage2D, uintptr(unsafe.Pointer(&target)), uintptr(unsafe.Pointer(&levels)), uintptr(unsafe.Pointer(&internalFormat)), uintptr(unsafe.Pointer(&width)), uintptr(unsafe.Pointer(&height)))
}
...
const (
	...
	_glTypeInt32   = 2 | 0x10
	_glTypeInt64   = 3 | 0x10
	_glTypeFloat32 = 4 | 0x10
	_glTypeFloat64 = 5 | 0x10
	_glTypeBoolean = 6 | 0x10
	_glTypeString  = 7 | 0x10
	_glTypeSlice   = 8 | 0x30
	_glTypeSlice32 = 9 | 0x30
	_glTypeValue   = 10 | 0x40
	_glTypeMethod  = 11 | 0x40
)
...
var (
	...
	_glBlendFunc                         = newProc(_glTypeNull, "blendFunc", _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64)
	_glBufferDataSize                    = newProc(_glTypeNull, "bufferData", _glTypeInt64, _glTypeInt64, _glTypeInt64)
	_glBufferData                        = newProc(_glTypeNull, "bufferData", _glTypeInt64, _glTypeByte, _glTypeInt64)
	...
	_glClearColor                        = newProc(_glTypeNull, "clearColor", _glTypeFloat64, _glTypeFloat64, _glTypeFloat64, _glTypeFloat64)
	_glClearDepth                        = newProc(_glTypeNull, "clearDepth", _glTypeFloat64)
	...
	_glFlush                             = newProc(_glTypeNull, "flush")
	...
	_glGetIndexedParameter               = newProc(_glTypeValue, "getIndexedParameter", _glTypeInt64, _glTypeInt64)
	...
	_glGetVertexAttrib                   = newProc(_glTypeValue, "getVertexAttrib", _glTypeInt64, _glTypeInt64)
	...
	_glIsEnabled                         = newProc(_glTypeBoolean, "isEnabled", _glTypeInt64)
	...
	_glUniform1f                         = newProc(_glTypeNull, "uniform1f", _glTypeValue, _glTypeFloat64)
	_glUniform2f                         = newProc(_glTypeNull, "uniform2f", _glTypeValue, _glTypeFloat64, _glTypeFloat64)
	_glUniform3f                         = newProc(_glTypeNull, "uniform3f", _glTypeValue, _glTypeFloat64, _glTypeFloat64, _glTypeFloat64)
	_glUniform4f                         = newProc(_glTypeNull, "uniform4f", _glTypeValue, _glTypeFloat64, _glTypeFloat64, _glTypeFloat64, _glTypeFloat64)
	...
	_glBufferSubData                     = newProc(_glTypeNull, "bufferSubData", _glTypeInt64, _glTypeInt64, _glTypeByte)
	_glCopyTexSubImage2D                 = newProc(_glTypeNull, "copyTexSubImage2D", _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64, _glTypeInt64)
)
